...
{
    public class LegsArmorInventorySlot : MonoBehaviour
    {
        public Image icon;
        ...
        public void AddLegsArmorItem(LegsArmorItem newitem, bool shop = false)
        {
            item = newitem;

            if (item.itemIcon == null) item.itemIcon = PlayerInventory.instance.legsArmorIcons[item.legsArmorModelID];
        ...
        public void ChangeEquippedLegsArmor()
        {
            ...
            {
                //UNEQUIP OLD WEAPON
                PlayerInventory.instance.equippedLegsArmor.equipped = false;

                //EQUIP NEW ARMOR
                item.equipped = true;
                PlayerInventory.instance.equippedLegsArmor = item;
                Debug.Log("Equipped: " + PlayerInventory.instance.equippedLegsArmor.itemName);
                ...
                PlayerInventory.instance.UpdateLegsArmorModel(true);
            }
            else
            {
                ...
                PlayerInventory.instance.equippedLegsArmor = PlayerInventory.instance.emptyLegsArmor;
                ...
                //ADD VISUAL CHANGE TO CHARACTER HERE
                PlayerInventory.instance.UpdateLegsArmorModel(false);
            }

            // ENABLE SELECTED BORDER
            transform.GetChild(1).gameObject.SetActive(true);
            PlayerStats.instance.PreviewLegsArmorStatChanges(item);
        }
