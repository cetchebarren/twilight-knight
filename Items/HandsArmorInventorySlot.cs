...
{
    public class HandsArmorInventorySlot : MonoBehaviour
    {
        public Image icon;
        ...
        public void AddHandsArmorItem(HandsArmorItem newitem, bool shop = false)
        {
            item = newitem;

            if (item.itemIcon == null) item.itemIcon = PlayerInventory.instance.handsArmorIcons[item.handsArmorModelID];          
        ...
        public void ChangeEquippedHandsArmor()
        {
            ...
            {
                //UNEQUIP OLD WEAPON
                PlayerInventory.instance.equippedHandsArmor.equipped = false;

                //EQUIP NEW ARMOR
                item.equipped = true;
                PlayerInventory.instance.equippedHandsArmor = item;
                Debug.Log("Equipped: " + PlayerInventory.instance.equippedHandsArmor.itemName);
                ...
                PlayerInventory.instance.UpdateHandsArmorModel(true);
            ...
            else
            {
                ...
                PlayerInventory.instance.equippedHandsArmor = PlayerInventory.instance.emptyHandsArmor;
                ...
                //ADD VISUAL CHANGE TO CHARACTER HERE
                PlayerInventory.instance.UpdateHandsArmorModel(false);
            }

            // ENABLE SELECTED BORDER
            transform.GetChild(1).gameObject.SetActive(true);
            PlayerStats.instance.PreviewHandsArmorStatChanges(item);
        }
