...
namespace etchebarren
{
    public class WeaponInventorySlot : MonoBehaviour
    {
        ...
        public void AddWeaponItem(WeaponItem newitem, bool shop=false)
        {
            item = newitem;

            if(item.itemIcon == null) item.itemIcon = PlayerInventory.instance.swordIcons[item.weaponModelID];   
        ...
        public void ChangeEquippedWeapon()
        {
            ...
            {
                //UNEQUIP OLD WEAPON
                PlayerInventory.instance.equippedWeapon.equipped = false;

                //EQUIP NEW WEAPON
                item.equipped = true;
                PlayerInventory.instance.equippedWeapon = item;
                Debug.Log("Equipped: " + PlayerInventory.instance.equippedWeapon.itemName);
                ...
                PlayerInventory.instance.UpdateWeaponModel();
            ...
            else
            {
                ...
                //EQUIP NEW WEAPON
                item.equipped = false;
                PlayerInventory.instance.equippedWeapon = PlayerInventory.instance.emptyWeapon;
                Debug.Log("Equipped: " + PlayerInventory.instance.equippedWeapon.itemName);
                AnimEvents.instance.infusionTimer = 0;
                playerMenuManager.UpdateUI();
            ...
            PlayerStats.instance.PreviewWeaponStatChanges(item);
        }
